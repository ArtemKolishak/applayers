<?php
/**
 * Widget API: Applayers_Widget_Subscribe_Form class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Applayers_Widget_Subscribe_Form extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'                   => 'widget_subscribe_form news_letter',
		...
		parent::__construct( 'subscribe_form', __( 'AppLayers Subscribe Form' ), $widget_ops, $control_ops );
	}
